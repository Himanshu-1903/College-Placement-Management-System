...
function LoginTPO() {
  ...
  return (
    <>
      ...
      <div className="flex justify-center items-center min-h-screen bg-gradient-to-br from-[#8B0000] via-slate-900 to-black relative overflow-hidden">


        <form className="form-signin flex justify-center items-center flex-col gap-6 backdrop-blur-xl bg-white/10 border border-white/20 rounded-3xl p-10 shadow-2xl shadow-black/50 w-1/3 max-lg:w-2/3 max-md:w-3/4 max-[400px]:w-4/5 relative z-10 hover:shadow-3xl transition-all duration-500 hover:scale-105" onSubmit={handleSubmit}>
          <div className='flex justify-center items-center flex-col'>
            <div className="relative">
              <img className="mb-6 rounded-2xl shadow-2xl w-32 h-32 lg:w-40 lg:h-40 border-4 border-white/20 backdrop-blur-sm" src="/iiita.jpg" alt="IIIT Allahabad Logo" />
              <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-white/20 to-transparent pointer-events-none"></div>
            </div>
            <h1 className="text-3xl font-light text-white mb-2 tracking-wide">Placement Officer Portal</h1>
            <p className="text-white/80 text-sm font-light">IIIT Allahabad Placement Portal</p>
          </div>
