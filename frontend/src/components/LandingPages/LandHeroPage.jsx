    ...
    >
      ...
      <div className="relative z-20 max-w-5xl text-center">
        <h1 className="text-white text-5xl sm:text-6xl md:text-7xl font-extrabold leading-tight drop-shadow-md">
          ...
          <span className="bg-gradient-to-r from-red-800 via-red-600 to-red-500 text-transparent bg-clip-text">
            IIIT Allahabad Placement Portal
          </span>
        </h1>
        ...
        <div className="mt-8">
          ...
          >
            Learn more about IIIT Allahabad Placement Portal
          </p>
        </div>
      </div>
    </section>
