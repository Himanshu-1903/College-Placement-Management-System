...
function Layout({ header }) {
  ...
  return (
    <div className="flex bg-gray-50 min-h-screen">
      ...
      {/* Mobile overlay */}
      {isSidebarVisible && (
        <div className="fixed inset-0 bg-black/20 z-20 lg:hidden" onClick={toggleSidebar}></div>
      )}

      <div className={`flex flex-col flex-1 min-w-0 transition-all duration-300 ${isSidebarVisible ? 'lg:ml-[260px]' : ''}`}>
        ...
        <Suspense fallback={<LoadingComponent />}>
          <Routes>
            ...
            <Route element={<UserProvider><ProtectedRoute allowedRoles={['tpo_admin']} /></UserProvider>}>
              ...
              <Route element={<Layout header="Placement Officer Dashboard" />}>
            ...
            <Route element={<UserProvider><ProtectedRoute allowedRoles={['management_admin']} /></UserProvider>}>
              ...
              <Route element={<Layout header="Institute Management Dashboard" />}>
              ...
              {/* list all tpo  */}
              <Route element={<Layout header="Placement Cell Coordinators" />}>
            ...
            <Route element={<UserProvider><ProtectedRoute allowedRoles={['superuser']} /></UserProvider>}>
              <Route element={<Layout header="Placement Cell Admin Panel" />}>
